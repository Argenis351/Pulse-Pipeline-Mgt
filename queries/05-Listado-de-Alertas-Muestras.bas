Operation =1
Option =0
Where ="((([05-Listado-de-Todos-Alertas].TipoDeAlerta)=4) And (([05-Listado-de-Todos-Ale"
    "rtas].FechaDeAlarma)>=Today() And ([05-Listado-de-Todos-Alertas].FechaDeAlarma)<"
    "=DateAdd(\"d\",Nz(TempVars!MuestraAlertPriorDays,5),Today()))) Or ((([05-Listado"
    "-de-Todos-Alertas].TipoDeAlerta)=4) And (([05-Listado-de-Todos-Alertas].FechaDeA"
    "larma)<=Today()))"
Begin InputTables
