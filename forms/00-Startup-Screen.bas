        ...
        Begin FormHeader
            ...
            Begin
                ...
                Begin Label
                    ...
                    FontSize =30
                    Name ="Title"
                    Caption ="Pulse - Sales Pipeline  Management"
                    FontName ="Trebuchet MS"
                    LayoutCachedLeft =1771
                    LayoutCachedTop =377
                    LayoutCachedWidth =12498
        ...
        Begin Section
            ...
            Begin
                Begin Label
                    ...
                    Height =795
                    Name ="Disclaimer"
                    Caption ="www.target-innovations.com"
                    Tag =";DoNotResize;"
                    HorizontalAnchor =2
                    VerticalAnchor =1
...
Private Sub Form_Load()
    ...
    Me.Title.Caption = Nz(DLookup("[SettingValue]", "SysSettings", "[SettingName]='SystemName'"), "") & " - " & Nz(DLookup("[SettingValue]", "SysSettings", "[SettingName]='SystemType'"), "")
    
    Dim WelcomeMessage As String
    WelcomeMessage = Nz(DLookup("[SettingLongValue]", "SysSettings", "[SettingName]='TrustingMessage'"), "")
    Me.WelcomeMessageRich = Replace(WelcomeMessage, "[SystemName]", Me.Title.Caption)
